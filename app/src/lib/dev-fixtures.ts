...
const TASKS: TaskSummary[] = [
  { id: 'tas-241', externalStoryId: 'sc-241', platform: 'shortcut', status: 'executing', tierEstimate: 'hard', repoRef: 'acme/api', claimedBy: 'nova', failureCount: 0 },
  { id: 'tas-219', externalStoryId: 'lin-219', platform: 'linear', status: 'executing', tierEstimate: 'medium', repoRef: 'acme/edge', claimedBy: 'juno', failureCount: 0 },
  { id: 'bill-77', externalStoryId: 'sc-77', platform: 'shortcut', status: 'needs_attention', tierEstimate: 'ultra', repoRef: 'acme/billing', claimedBy: 'sable', failureCount: 3 },
  { id: 'tas-271', externalStoryId: 'lin-271', platform: 'linear', status: 'routable', tierEstimate: 'medium', repoRef: 'acme/api', claimedBy: null, failureCount: 0 },
  { id: 'tas-205', externalStoryId: 'gh-205', platform: 'github', status: 'done', tierEstimate: 'hard', repoRef: 'acme/api', claimedBy: 'pike', failureCount: 0 },
];
