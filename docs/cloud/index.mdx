...
**Tasca Cloud** adds team collaboration to Tasca. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same Tasca interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same Tasca installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run Tasca** as usual with `npx tasca`
...
Think of it as your company or team in Tasca.
...
- Review code directly in Tasca
- Track PR status

## Getting Started

<Steps>
<Step title="Run Tasca">
  ```bash
  npx tasca
  ```
</Step>
