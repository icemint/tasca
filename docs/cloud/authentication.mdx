...
Tasca Cloud uses OAuth authentication, allowing you to sign in with your existing GitHub or Google account instead of creating a new password.
...
OAuth is a secure way to sign in to applications using accounts you already have. When you click "Sign in with GitHub", you're redirected to GitHub to confirm you want to allow Tasca access. GitHub then tells Tasca who you are, without Tasca ever seeing your GitHub password.
</Info>
...
<Step title="Authorise on Provider">
  ...
  Click **Authorize** (GitHub) or **Allow** (Google) to grant Tasca access.
</Step>

<Step title="Redirected Back">
  After authorising, you're automatically redirected back to Tasca and signed in.
</Step>
</Steps>

### What Tasca Can Access

When you authorise Tasca, it only requests minimal permissions:
...
2. Find "Tasca Cloud" and revoke access
...
3. Sign out there
4. Return to Tasca and sign in - you'll be prompted to log in to the provider

## Security Best Practices

<CardGroup cols={2}>
<Card title="Use a strong provider password" icon="lock">
  Your Tasca security depends on your GitHub/Google account security. Use a strong, unique password.
</Card>
...
2. If you're part of a GitHub organisation with app restrictions, ask your admin to approve Tasca
</Accordion>
...
**Problem:** You revoked Tasca's access on GitHub/Google and now can't sign in.
