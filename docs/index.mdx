...
Tasca is built for this. Use kanban issues to plan work, either privately or with your team. When you’re ready to begin, create workspaces where coding agents can execute.
...
<Frame>
  <img src="/images/onboarding-workspaces-logs.png" alt="Tasca workspace showing the logs panel with command output from running processes" />
</Frame>