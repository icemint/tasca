...
description: "Learn how to create and configure projects in Tasca"
---

Before you can create tasks and execute coding agents, you must create a project.

<Frame>
<img src="/images/tasca-create-project.png" alt="Create project dialog showing options to create from existing git repository or blank project" />
</Frame>
