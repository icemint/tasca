...
description: "Learn how to complete tasks by rebasing, merging, and managing pull requests directly from Tasca"
sidebarTitle: "Completing a Task"
---

When your task is finished, Tasca provides integrated git operations to keep your branch up-to-date and merge your work back into the base branch.
...
<Frame>
<img src="/images/tasca-diff-header.png" alt="Diff header showing branch information and action buttons" />
</Frame>
...
<Frame>
<img src="/images/tasca-pr-open.png" alt="Header showing disabled Push button after pull request creation" />
</Frame>
...
<Frame>
<img src="/images/tasca-pr-with-push.png" alt="Header showing enabled Push button with new changes ready" />
</Frame>
