...
<Frame>
<img src="/images/tasca-task-dialog.png" alt="Task creation interface showing Add Task button and form fields" />
</Frame>
...
<Frame>
<img src="/images/tasca-new-task-attempt.png" alt="Task attempt creation dialog showing agent profile and variant selection options" />
</Frame>
...
<Tip>
For detailed setup instructions and examples, see the [Tasca MCP Server](/integrations/tasca-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Tasca project based on this description.
