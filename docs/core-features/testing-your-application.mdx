...
Preview Mode provides an embedded browser experience within Tasca, allowing you to test and iterate on your web applications without leaving the development environment. This feature eliminates the need to switch between your browser and Tasca by providing live preview capabilities and precise component selection tools.

**Key Benefits:**
- **Embedded viewing**: See your application running directly in Tasca
...
<Step title="Install Web Companion">
  For precise component selection, install the `tasca-web-companion` package in your application.

  <Info>
  **Recommended**: Use the "Install companion automatically" button in the Preview tab to have Tasca create a task that installs and configures the companion for you.
  ...
  **Manual Installation:**
  ...
  ```bash
  npm install tasca-web-companion
  ```
  ...
  <Tab title="Create React App">
    ...
    ```jsx
    import { TascaWebCompanion } from 'tasca-web-companion';
...
3. **Interact with your app** directly within Tasca

<Frame>
<img src="/images/tasca-preview-interface.png" alt="Preview mode showing embedded application with toolbar controls" />
</Frame>
...
<Frame>
<img src="/images/tasca-preview-toolbar.png" alt="Preview toolbar showing refresh, copy URL, open in browser, and stop server controls" />
</Frame>
...
<Frame>
<img src="/images/tasca-dev-server-logs.png" alt="Dev Server Logs showing expandable/collapsible log output at bottom of preview" />
</Frame>
...
<Step title="Activate Selection Mode">
  Click the floating Tasca companion button in the bottom-right corner of your application to activate component selection mode.

  <Frame>
  <img src="/images/tasca-component-selection.png" alt="Component selection interface showing selectable elements highlighted" />
  </Frame>
</Step>

<Step title="Choose Component Depth">
  When you click a component, Tasca shows a hierarchy of components from innermost to outermost. Select the appropriate level for your feedback:
...
- [Configuration & Customisation](/configuration-customisation/global-settings) - Customise Tasca settings
