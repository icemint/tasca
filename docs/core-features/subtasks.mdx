...
<Frame>
<img src="/images/tasca-create-subtask-button.png" alt="Current attempt toolbar showing the Create Subtask button with GitFork icon" />
</Frame>
...
Subtasks in Tasca follow these key principles:
