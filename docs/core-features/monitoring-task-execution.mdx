...
<Frame>
<img src="/images/tasca-agent-log-main.png" alt="Task execution showing real-time agent logs with actions and responses" />
</Frame>

## What Happens During Execution

When you start a task attempt, Tasca orchestrates several steps to create an isolated environment and execute your task:
...
Tasca uses Git worktrees to create isolated environments for each task attempt. These environments are ephemeral and automatically cleaned up after execution completes.
...
<Frame>
<img src="/images/tasca-approval.png" alt="Approval prompt showing tick and cross buttons to approve or deny an agent action" />
</Frame>
...
Tasca generates commit messages based on the last message sent by the agent. These automated messages may not always be the most descriptive.
...
<Frame>
<img src="/images/tasca-task-title.png" alt="Task title in top left corner, click to view full task details" />
</Frame>
...
<Frame>
<img src="/images/tasca-edit-message.png" alt="Editing a previous message with options to save or cancel changes" />
</Frame>
...
<Frame>
<img src="/images/tasca-processes-dropdown.png" alt="Processes dropdown showing coding agent and development server processes" />
</Frame>
