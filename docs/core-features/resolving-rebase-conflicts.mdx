...
<Frame>
<img src="/images/tasca-rebase-conflicts-top.png" alt="Task showing rebase conflicts status with conflict resolution options" />
</Frame>

The conflict banner provides three options to resolve the situation:

<Frame>
<img src="/images/tasca-rebase-banner.png" alt="Conflict resolution banner showing the three available options" />
</Frame>
...
<Frame>
<img src="/images/tasca-rebase-conflicts-prompt.png" alt="Conflict resolution banner with auto-generated instructions in the follow-up field" />
</Frame>
