...
When you add a repository to a workspace, Tasca creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.tasca-workspaces` directory (configurable in Settings).
</Accordion>
