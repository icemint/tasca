...
<Info>
Agent profiles are used throughout Tasca wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. Tasca saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Tasca for your coding agents
</Card>

<Card title="Tasca MCP Server" icon="plug" href="/integrations/tasca-mcp-server">
  Connect external MCP clients to Tasca's MCP server
</Card>
</CardGroup>
