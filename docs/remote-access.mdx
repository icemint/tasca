---
title: "Remote Access"
description: "Access your local Tasca instance from another device"
---

Remote Access allows you to access a host instance of Tasca from another device, like your mobile phone.

# 1. Launch Tasca on the host device

Make sure you've started Tasca and logged in.
...
# 3. Log into Tasca cloud

On the client device where you'd now like to access your host machine from, navigate to [cloud.tasca.dev](https://cloud.tasca.dev) in a browser and log in.
...
<Frame>
  <img style={{maxHeight: "500px"}} src="/images/remote-access-cloud-mobile.png" alt="Tasca cloud remote access page on mobile showing a paired host and workspaces" />
</Frame>
