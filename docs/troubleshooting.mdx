...
description: "Common issues and solutions when using Tasca"
---
...
If you encounter irrecoverable errors and need to completely wipe your Tasca database, you can delete the application data directory for your operating system. 
...
<Tab title="macOS">
```bash
~/Library/Application Support/dev.tasca.app/
```
</Tab>
...
Typically: `C:\Users\<username>\AppData\Roaming\tasca\`
</Tab>
</Tabs>

After deleting the application data directory, restart Tasca to reset with an empty database and default settings.
