...
description: "Run Tasca Cloud locally"
---

This guide walks you through setting up a local Tasca Cloud instance for development and testing.
...
```bash
git clone https://github.com/icemint/tasca.git
cd tasca
```
...
TASCA_REMOTE_JWT_SECRET=<paste_your_generated_secret_here>
...
Open [http://localhost:3000](http://localhost:3000) in your browser. You should see the Tasca Cloud login page.
