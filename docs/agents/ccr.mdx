...
icon: https://www.tasca.dev/images/logos/claude.svg#"
---
...
## Authentication
Authenticate and configure CCR outside of Tasca. Follow the instructions on the CCR GitHub repo:
...
Tasca does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Tasca

<Frame>
<img src="/images/tasca-ccr-agent-config.png" alt="Claude Code agent configuration in Tasca" />
</Frame>
