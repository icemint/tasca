...
icon: https://www.tasca.dev/images/logos/factory-ai-logo-light.png
---
...
<Step title="Authenticate with Factory AI">
  To use Droid in Tasca, you must first authenticate:
...
Droid supports several configuration options in Tasca:
...
These options can be configured when creating agent configurations in Tasca.
